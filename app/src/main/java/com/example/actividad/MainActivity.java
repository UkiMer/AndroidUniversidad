...
public class MainActivity extends AppCompatActivity {
    ...
    public void ActualizarUsuario(View view){
        ...
        String NicknameUser = Nickname.getText().toString();
        String CampeonUser = Campeon.getText().toString();
        String RolUser = Rol.getSelectedItem().toString();
        String DivisionUser = Division.getSelectedItem().toString();
        if (!IDUser.isEmpty() && !NicknameUser.isEmpty() && !CampeonUser.isEmpty() && !RolUser.isEmpty() && !DivisionUser.isEmpty()){
            ContentValues DatosUsuario = new ContentValues();
            DatosUsuario.put("Nickname", NicknameUser);
            DatosUsuario.put("Campeon", CampeonUser);
            DatosUsuario.put("Rol", RolUser);
    ...
    // Mostrar en un activity nuevo la tabla creada
    public void MostrarUsuariosRegistrados(View view){
        Intent formResultado = new Intent(this, MostrarUsuariosRegistrados.class);
        startActivity(formResultado);
    }
}